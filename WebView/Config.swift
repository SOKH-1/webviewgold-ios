...
var askforpushpermissionatfirstrun = false //Set to "true" to ask your users for push notifications permission at the first run of your application in general (for OneSignal, Firebase, and JavaScript API). Set it to "false" to never ask or to ask with a registerpush:// URL call in your web app later
...
static var AdmobBannerID = "ca-app-pub-4607387299207079/3149201960" //Set the AdMob ID for banner ads

static var AdmobinterstitialID = "ca-app-pub-4607387299207079/6841034964" //Set the AdMob ID for interstitial ads
    
static var AdmobRewardedID = "ca-app-pub-4607387299207079/5527953298" //Set the AdMob ID for rewarded ads
...
static let showadAfterX = 4 //Show AdMob interstitial ads each X website requests/loads OR taps -> depending on incrementWithTaps setting
...
static let useAdsenseAds = true //Set to "true" to enable support for AdSense web ads (independent of AdMob ads)
